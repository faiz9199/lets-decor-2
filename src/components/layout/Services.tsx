  ...
  const Services: React.FC = () => {
    ...
    return (
      <div>
        <p
        className="md:mx-12 mx-6 my-8 md:text-3xl text-xl text-center font-semibold"
      >
          Some of the following Services we offer
        </p>
        <div className="md:grid-cols-4 sm:grid-cols-2 grid justify-center gap-4 mx-4 md:mx-12">
          {data.map((dat) => (
